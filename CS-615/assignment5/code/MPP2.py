...
L5 = TanhLayer()
L10 = dropOutLayer(0.2)
L6 = fullyConnectedLayer(196, 10)
L7 = SoftmaxLayer()
L8 = CrossEntropyLoss()

L = [L1, L2, L3, L9, L4, L5, L10, L6, L7, L8]
...
epoch_kf, avg_eval_train, avg_eval_test, accuracy_train_kf, accuracy_test_kf = kfold_cross_validation(X, Y, 5, L, epoch=100, early_stopping=False)

print("average accuracy on training set: ", np.mean(accuracy_train_kf))
print("average accuracy on testing set: ", np.mean(accuracy_test_kf))
